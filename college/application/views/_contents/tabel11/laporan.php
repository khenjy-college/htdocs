    ...
    <table class="table">
      ...
      <tbody>
        <?php foreach ($tbl11 as $tl11) : ?>
          <tr>
            <td width=""><?= $tl11->$tabel11_field1; ?></td>
            <td width=""><?= $tl11->$tabel11_field2 ?></td>
            <td width=""><?= $tl11->$tabel11_field3 ?></td>
            <td width=""><?= $tl11->$tabel11_field4 ?></td>
            <td width=""><?= $tl11->$tabel11_field5 ?></td>
            <td width=""><?= $tl11->$tabel11_field6 ?></td>
          </tr>
        <?php endforeach ?>
      </tbody>
    </table>
