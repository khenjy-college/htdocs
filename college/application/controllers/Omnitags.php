...
class Omnitags extends CI_Controller
{
    ...
    public function declarew()
    {
        ...
        $jsonData1 = file_get_contents(site_url('assets/json/college.postman_environment.json'));
        ...
        $jsonData2 = file_get_contents(site_url('assets/json/college_tables.postman_environment.json'));
