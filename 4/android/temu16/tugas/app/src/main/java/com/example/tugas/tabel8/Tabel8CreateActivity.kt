...
class Tabel8CreateActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        enableEdgeToEdge()
        setContentView(R.layout.activity_tabel8_create)
        ...
        btnSimpan.setOnClickListener {
            ...
            val tableName = getString(R.string.tabel8)
            db.execSQL("INSERT INTO $tableName (" +
                    "${getString(R.string.tabel8_field1)}, " +
                    "${getString(R.string.tabel8_field2)}, " +
                    "${getString(R.string.tabel8_field3)}, " +
                    "${getString(R.string.tabel8_field4)}, " +
                    "${getString(R.string.tabel8_field5)}) " +
                    "VALUES ('$tabel8_field1Text', '$tabel8_field2Text', '$tabel8_field3Text', '$tabel8_field4Text', '$tabel8_field5Text')")
            Toast.makeText(this@Tabel8CreateActivity, "Data tersimpan", Toast.LENGTH_SHORT).show()
