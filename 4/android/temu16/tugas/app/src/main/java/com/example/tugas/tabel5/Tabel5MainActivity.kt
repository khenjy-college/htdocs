...
class Tabel5MainActivity : AppCompatActivity() {
    ...
    companion object {
        ...
        lateinit var ma: Tabel5MainActivity
    }

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        enableEdgeToEdge()
        setContentView(R.layout.activity_tabel5_main)
        ...
        fab.setOnClickListener {
            val move = Intent(this@Tabel5MainActivity, Tabel5CreateActivity::class.java)
            startActivity(move)
        }
    ...
    fun refreshList() {
        ...
        cursor = db.rawQuery("SELECT * FROM ${getString(R.string.tabel5)}", null)
        ...
        listview.setOnItemClickListener { _, _, position, _ ->
            ...
            val items = arrayOf<CharSequence>(
                "Lihat ${getString(R.string.tabel5_alias)}",
                "Update ${getString(R.string.tabel5_alias)}",
                "Delete ${getString(R.string.tabel5_alias)}"
            )
            val builder = AlertDialog.Builder(this@Tabel5MainActivity)
