...
class Tabel8DetailActivity : AppCompatActivity() {
    protected lateinit var cursor: Cursor

    private lateinit var database: Database

    private lateinit var tabel8_field1: TextView
    private lateinit var tabel8_field2: TextView
    private lateinit var tabel8_field3: TextView
    private lateinit var tabel8_field4: TextView
    private lateinit var tabel8_field5: TextView
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (cursor.moveToFirst()) {
            tabel8_field1.text = cursor.getString(0)
            tabel8_field2.text = cursor.getString(1)
            tabel8_field3.text = cursor.getString(2)
            tabel8_field4.text = cursor.getString(3)
            tabel8_field5.text = cursor.getString(4)
        }
    }
}
