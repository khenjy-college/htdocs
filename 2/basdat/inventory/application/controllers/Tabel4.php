...
class Tabel4 extends Welcome
{
	...
	public function update_profil()
	{
		...
		$tabel9_field2 = $tabel4[0]->EmpFirstName;
		$tabel9_field3 = $tabel4[0]->EmpLastName;
		$tabel9_field4 = $tabel4[0]->Email;
	...
	public function ceklogin()
	{
		...
		if ($method1->num_rows() > 0) {
			...
			if (password_verify($param4, $method8)) {
				$tabel9_field1 = $tabel4[0]->EmpNo;
				$tabel9_field2 = $tabel4[0]->EmpFirstName;
				$tabel9_field3 = $tabel4[0]->EmpLastName;
				$tabel9_field4 = $tabel4[0]->EmpEmail;
