  ...
  <li class="nav-item">
    <div class="dropdown">
      ...
      <div class="dropdown-menu dropdown-menu-right">
        ...
        <a class="dropdown-item" href="<?= site_url('history') ?>">History Pesanan</a>

        <div class="dropdown-divider"></div>
        <h6 class="dropdown-header">Operasional Hotel</h6>
        <a class="dropdown-item" href="<?= site_url('operations') ?>">Operations</a>

        <div class="dropdown-divider"></div>
        <h6 class="dropdown-header">Data Hotel</h6>
        <a class="dropdown-item" href="<?= site_url('kamar') ?>">Daftar Kamar</a>
