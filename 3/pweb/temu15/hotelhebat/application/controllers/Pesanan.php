...
class Pesanan extends Welcome
{
	...
	public function tambah()
	{
		...
		$timedif = abs($endTimeStamp - $startTimeStamp);
		$numberdays = $timedif / 86400; // 86400 seconds in one day

		$selisih = intval($numberdays);
		...
		$harga_total = ($selisih * $tipe_kamar[0]->harga);
	...
	public function update_status()
	{
		...
		if ($this->tabel8_v_input12_post == $this->tabel8_field12_value4) {
			...
			$data = array(
				$this->tabel2_field13 => $this->session->userdata($this->tabel9_userdata2)
			);
