...
class History extends Welcome
{
	...
	declare()
	{
		...
		$this->tabel2_v_input10_filter1 = $this->tabel2_v_input10 . '_min';
		$this->tabel2_v_input10_filter1_get = $this->input->get($this->tabel2_v_input10 . '_min');
		$this->tabel2_v_input10_filter2 = $this->tabel2_v_input10 . '_max';
		$this->tabel2_v_input10_filter2_get = $this->input->get($this->tabel2_v_input10 . '_max');
		//ini adalah filter
		...
		$this->tabel2_v_input11_filter1_get = $this->input->get($this->tabel2_v_input11 . '_min');
		$this->tabel2_v_input11_filter2 = $this->tabel2_v_input11 . '_max';
		$this->tabel2_v_input11_filter2_get = $this->input->get($this->tabel2_v_input11 . '_max');
