<ul class="navbar-nav ml-auto">
    <?php switch ($this->session->userdata($tabel9_field6)) {
        case $tabel9_field6_value1:
            ...
            <li class="nav-item">
                <a class="nav-link text-decoration-none font-weight-bold" href="<?= site_url('tabel6/admin') ?>">
                    <?= $tabel6_alias ?>
                </a>
            </li>
            <li class="nav-item">
                <a class="nav-link text-decoration-none font-weight-bold" href="<?= site_url('tabel3/admin') ?>">
                    <?= $tabel3_alias ?>
                </a>
            </li>
            <li class="nav-item">
