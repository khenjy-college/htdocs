...
class Omnitags extends CI_Controller
{
    ...
    public function declarew()
    {
        ...
        $this->views = array(
            ...
            'tabel10_v2_alt_title' => 'Daftar ' . $this->aliases['tabel10_alias'] . $this->aliases['tabel2_alias'],
            'tabel10_v3_alt' => '_contents/tabel10/admin_tabel2',
            'tabel10_v3_alt_title' => 'Data ' . $this->aliases['tabel10_alias'] . $this->aliases['tabel2_alias'],
