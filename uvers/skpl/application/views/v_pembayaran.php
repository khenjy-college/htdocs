    ...
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title">Transaksi untuk Pesanan <?= $tl8->$tabel8_field1 ?></h5>
            ...
            <div class="row">
              ...
              <div class="col-md-12">
                ...
                <div class="form-group">
                  ...
                  <input type="hidden" name="id_pesanan" value="<?= $tl8->$tabel8_field1 ?>">
                </div>

                <div class="form-group">
                  <label>Metode Pesanan</label>
                  <select class="form-control" required name="metode">
                    <option selected hidden value="">Pilih Metode Pesanan...</option>
                    <option>debit</option>
...
<?php foreach ($tbl8 as $tl8) :
  foreach ($tbl6 as $tl6) :
    if ($tl6->$tabel6_field1 == $tl8->$tabel8_field7) { ?>
      ...
      <div id="kamar<?= $tl8->$tabel8_field1 ?>" class="modal fade lihat">
        <div class="modal-dialog">
          <div class="modal-content">
            <div class="modal-header">
              <h5 class="modal-title"><?= $tabel8_alias ?> <?= $tl8->$tabel8_field1 ?></h5>
              ...
              <div class="row">
                ...
                <div class="col-md-6">
                  <?php foreach ($tbl5 as $tl5) : ?>
                    <?php if ($tl8->$tabel8_field1 == $tl5->id_pesanan) { ?>
