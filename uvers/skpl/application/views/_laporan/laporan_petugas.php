    ...
    <table class="table">
      ...
      <tbody>
        <?php foreach ($tbl4 as $tl4) : ?>
          <tr>
            <td width="10%"><?= $tl4->$tabel4_field1; ?></td>
            <td width="10%"><?= $tl4->$tabel4_field2 ?></td>
            <td width="20%"><?= $tl4->$tabel4_field3 ?></td>
            <td width="10%"><?= $tl4->$tabel4_field4 ?></td>
            <td width="20%"><?= $tl4->$tabel4_field5 ?></td>
          </tr>
        <?php endforeach ?>
      </tbody>
    </table>
