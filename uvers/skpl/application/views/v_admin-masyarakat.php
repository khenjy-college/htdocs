    ...
    <tbody>
      <?php foreach ($tbl4 as $tl4) : ?>
        <tr>
          ...
          <td><a class="btn btn-light text-info" type="button" data-toggle="modal" data-target="#lihat<?= $tl4->$tabel4_field1; ?>">
              <i class="fas fa-eye"></i></a>
            <a class="btn btn-light text-warning" type="button" data-toggle="modal" data-target="#ubah<?= $tl4->$tabel4_field1; ?>">
          ...
          <div class="input-group">
            ...
            <select class="form-control" required name="<?= $tabel4_field4 ?>">
              ...
              <?php foreach ($tbl5 as $tl5) : ?>
                <option value="<?= $tl5->$tabel5_field1 ?>"><?= $tl5->$tabel5_field2 ?></option>
              <?php endforeach; ?>
            </select>
          </div>
        ...
        <form action="<?= site_url($tabel4.'/update') ?>" method="post" enctype="multipart/form-data">
          <div class="modal-body">
            <div class="input-group">
              ...
              <input class="form-control" type="text" required name="<?= $tabel4_field2 ?>" placeholder="Masukkan <?= $tabel4_field2_alias ?>" value="<?= $tl4->$tabel4_field2 ?>">
            ...
            <div class="input-group">
              ...
              <input class="form-control" type="text" required name="<?= $tabel4_field3 ?>" placeholder="Masukkan <?= $tabel4_field3_alias ?>" value="<?= $tl4->$tabel4_field3 ?>">
            </div>
            ...
            <div class="input-group">
              ...
              <select class="form-control" required name="<?= $tabel5_field1 ?>">
                <?php foreach ($tbl5 as $tl5) :
                  if ($tl4->$tabel4_field4 == $tl5->$tabel5_field1) { ?>
                    <option value="<?= $tl4->$tabel4_field4 ?>" selected hidden><?= $tl5->$tabel5_field2 ?></option>
                  <?php } ?>
                <?php endforeach; ?>
            ...
            <div class="input-group">
              ...
              <textarea class="form-control" name="<?= $tabel4_field5 ?>" id="inputAlamat" placeholder="Masukkan <?= $tabel4_field5_alias ?>"><?= $tl4->$tabel4_field5 ?></textarea>
            </div>
