...
class Omnitags extends CI_Controller
{
    ...
    public function declarew()
    {
        ...
        $jsonData1 = file_get_contents(site_url('assets/json/college_uvers_skpl.postman_environment.json'));
        ...
        $jsonData2 = file_get_contents(site_url('assets/json/college_uvers_skpl_tables.postman_environment.json'));
        ...
        foreach ($myData2 as $item) {
            ...
            $this->views_v2_title[$item['key']] = 'Data ' . $item['value'];
