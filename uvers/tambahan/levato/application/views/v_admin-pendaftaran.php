      ...
      <form action="<?= site_url() . $tabel3 . '/tambah' ?>" method="post">
        <div class="modal-body">
          <div class="form-group">
            ...
            <input class="form-control" type="text" required name="<?= $tabel3_field2 ?>" placeholder="Masukkan <?= $tabel3_field2_alias ?>">
          </div>

          <div class="form-group">
            <label><?= $tabel3_field3_alias ?></label>
            <input class="form-control" type="text" required name="<?= $tabel3_field3 ?>" placeholder="Masukkan <?= $tabel3_field3_alias ?>">
          </div>

          <div class="form-group">
            <label><?= $tabel3_field4_alias ?></label>
            <input class="form-control" type="text" required name="<?= $tabel3_field4 ?>" placeholder="Masukkan <?= $tabel3_field4_alias ?>">
          </div>

          <div class="form-group">
            <label><?= $tabel3_field5_alias ?></label>
            <input class="form-control" type="text" required name="<?= $tabel3_field5 ?>" placeholder="Masukkan <?= $tabel3_field5_alias ?>">
          </div>
      ...
      <div class="modal-content">
        ...
        <form action="<?= site_url() . $tabel3 . '/update' ?>" method="post" enctype="multipart/form-data">
          <div class="modal-body">
            <div class="form-group">
              <label><?= $tabel3_field2_alias ?></label>
              <input class="form-control" type="text" required name="<?= $tabel3_field2 ?>" value="<?= $tl3->$tabel3_field2; ?>">
              <input type="hidden" name="<?= $tabel3_field1 ?>" value="<?= $tl3->$tabel3_field1; ?>">
            </div>

            <div class="form-group">
              <label><?= $tabel3_field3_alias ?></label>
              <input class="form-control" type="text" required name="<?= $tabel3_field3 ?>" value="<?= $tl3->$tabel3_field3; ?>">
            </div>

            <div class="form-group">
              <label><?= $tabel3_field4_alias ?></label>
              <input class="form-control" type="text" required name="<?= $tabel3_field4 ?>" value="<?= $tl3->$tabel3_field4; ?>">
            </div>

            <div class="form-group">
              <label><?= $tabel3_field5_alias ?></label>
              <input class="form-control" type="text" required name="<?= $tabel3_field5 ?>" value="<?= $tl3->$tabel3_field5; ?>">
            </div>
          </div>
      ...
      <div class="modal-content">
        ...
        <form>
          <div class="modal-body">
            ...
            <div class="form-group">
              <label><?= $tabel3_field4_alias ?> : </label>
              <p><?= $tl3->$tabel3_field4; ?></p>
            </div>

            <div class="form-group">
              <label><?= $tabel3_field5_alias ?> : </label>
              <p><?= $tl3->$tabel3_field5; ?></p>
            </div>
          </div>
