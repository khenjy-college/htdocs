<?php if ($this->session->userdata($tabel9_field6) <> 'accounting') {
...
<!-- <table class="mb-4">
  ...
  <form action="< site_url($tabel10.'/filter') ?>" method="get">
    <tr>
      ...
      <td>
        ...
        <a class="btn btn-light text-info" type="button" href="< site_url($tabel10.'') ?>">
      ...
      <?php foreach ($tabel10 as $tl10) : ?>
        <tr>
          ...
          <td>
            ...
            <a class="btn btn-light text-info" href="<?= site_url($tabel10.'/receipt/' . $tl10->$tabel10_field1) ?>" target="_blank">
...
<!-- modal lihat -->
<!-- Tabel transaksi dan tabel pembayaran literally sudah bergabung
Jadi tidak perlu menambahkan foreach pembayaran lagi -->
<?php foreach ($tabel10 as $tl10) : ?>
  <div id="lihat<?= $tl10->$tabel10_field1 ?>" class="modal fade lihat" role="dialog">
    <?php foreach ($tabel6 as $tl6) : ?>
      <?php if ($tl6->id_usaha === $tl10->id_usaha) { ?>
          ...
          <div class="modal-content">
            ...
            <div class="modal-body">
              <div class="row">
                ...
                <!-- Di sini adalah bagian menampilkan data pembayaran -->
