      ...
      <div class="col-md-5 login">
        ...
        <form action="<?= site_url('tabel9/tambah') ?>" method="post">
          <div class="input-group">
            ...
            <input type="hidden" name="<?= $tabel9_v_input6 ?>" value="<?= $tabel9_field6_value5 ?>">
          </div>
          ...
          <div class="input-group">
            ...
            <input class="form-control" type="email" required name="<?= $tabel9_v_input3 ?>" placeholder="Masukkan <?= $tabel9_field3_alias ?>">
          </div>
