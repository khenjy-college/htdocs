      ...
      <form action="<?= site_url('tabel9/tambah') ?>" method="post">
        <div class="modal-body">
          <div class="input-group">
            ...
            <input class="form-control" type="text" required name="<?= $tabel9_v_input2 ?>" placeholder="Masukkan <?= $tabel9_field2_alias ?>">
          </div>
          ...
          <div class="input-group">
            ...
            <input class="form-control" type="text" required name="<?= $tabel9_v_input3 ?>" placeholder="Masukkan <?= $tabel9_field3_alias ?>">
          </div>
          ...
          <div class="input-group">
            ...
            <input class="form-control" type="password" required name="<?= $tabel9_v_input4 ?>" placeholder="Masukkan <?= $tabel9_field4_alias ?>">
          </div>
          ...
          <div class="input-group">
            ...
            <input class="form-control" type="text" required name="<?= $tabel9_v_input5 ?>" placeholder="Masukkan <?= $tabel9_field5_alias ?>">
          </div>
          ...
          <div class="input-group">
            ...
            <select class="form-control" required name="<?= $tabel9_v_input6 ?>">
        ...
        <form action="<?= site_url('tabel9/update') ?>" method="post" enctype="multipart/form-data">
          <div class="modal-body">
            <div class="input-group">
              ...
              <input class="form-control" type="text" required name="<?= $tabel9_v_input2 ?>" value="<?= $tl9->$tabel9_field2; ?>">
              <input type="hidden" name="<?= $tabel9_v_input1 ?>" value="<?= $tl9->$tabel9_field1; ?>">
            </div>
            ...
            <div class="input-group">
              ...
              <input class="form-control" type="text" required name="<?= $tabel9_v_input3 ?>" value="<?= $tl9->$tabel9_field3; ?>">
            </div>
            ...
            <div class="input-group">
              ...
              <input class="form-control" type="text" required name="<?= $tabel9_v_input5 ?>" value="<?= $tl9->$tabel9_field5; ?>">
            </div>
