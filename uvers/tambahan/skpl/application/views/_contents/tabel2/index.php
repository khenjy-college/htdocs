        ...
        <tr>
          ...
          <td class="pr-2">
            <div class="input-group input-group-sm">
              ...
              <input type="date" class="form-control" name="<?= $tabel2_v_input11_filter1 ?>" value="<?= $tabel2_v_input11_filter1_value ?>">
            </div>
          </td>
          <td class="pr-2">
            <div class="input-group input-group-sm">
              ...
              <input type="date" class="form-control" name="<?= $tabel2_v_input11_filter2 ?>" value="<?= $tabel2_v_input11_filter2_value ?>">
            </div>
          </td>
        </tr>
        ...
        <tr>
          ...
          <td class="pr-2">
            <div class="input-group input-group-sm">
              ...
              <input type="date" class="form-control" name="<?= $tabel2_v_input12_filter1 ?>" value="<?= $tabel2_v_input12_filter1_value ?>">
          ...
          <td class="pr-2">
            <div class="input-group input-group-sm">
              ...
              <input type="date" class="form-control" name="<?= $tabel2_v_input12_filter2 ?>" value="<?= $tabel2_v_input12_filter2_value ?>">
            </div>
          </td>
        </tr>
      </table>
