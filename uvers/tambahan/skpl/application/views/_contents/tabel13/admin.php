      ...
      <form action="<?= site_url('tabel13/tambah') ?>" enctype="multipart/form-data" method="post">
        <div class="modal-body">
          <div class="form-group">
            ...
            <input class="form-control" type="text" required name="<?= $tabel13_v_input2 ?>"
              placeholder="Masukkan <?= $tabel13_field2_alias ?>">
          </div>

          <div class="form-group">
            <label><?= $tabel13_field3_alias ?></label>
            <input class="form-control" type="text" required name="<?= $tabel13_v_input3 ?>"
              placeholder="Masukkan <?= $tabel13_field3_alias ?>">
          </div>

          <div class="form-group">
            <label><?= $tabel13_field4_alias ?></label>
            <input class="form-control-file" required type="file" name="<?= $tabel13_v_input4 ?>">

          </div>

          <div class="form-group">
            <label><?= $tabel13_field5_alias ?></label>
            <textarea class="form-control" name="<?= $tabel13_v_input5 ?>" placeholder="Masukkan <?= $tabel13_field5_alias ?>" required cols="30" rows="10"></textarea>
          </div>
        ...
        <form action="<?= site_url('tabel13/update') ?>" method="post" enctype="multipart/form-data">
          <div class="modal-body">
            ...
            <div class="form-group">
              ...
              <input type="hidden" name="<?= $tabel13_v_input1 ?>" value="<?= $tl13->$tabel13_field1; ?>">
            ...
            <div class="form-group">
              ...
              <input class="form-control-file" type="file" name="<?= $tabel13_v_input4 ?>">
              <input type="hidden" name="<?= $tabel13_v_input4_alt ?>" value="<?= $tl13->$tabel13_field4; ?>">
            </div>

            <div class="form-group">
              <label><?= $tabel13_field3_alias ?></label>
              <textarea class="form-control" name="<?= $tabel13_v_input5 ?>" placeholder="Masukkan <?= $tabel13_field5_alias ?>" required cols="30"
