  ...
  <div class="row justify-content-start mt-4">
    ...
    <div class="col-md-6">
      ...
      <div class="form-group">
        ...
        <input class="form-control" type="text" required name="<?= $tabel8_v_input3 ?>" placeholder="Masukkan <?= $tabel8_field3_alias ?>" value="<?= $this->session->userdata($tabel9_field2) ?>">
        <?php if ($this->session->userdata($tabel9_field1)) { ?>
          <input type="hidden" name="<?= $tabel9_v_input1 ?>" value="<?= $this->session->userdata($tabel9_field1) ?>">
        <?php } else { ?>
      ...
      <div class="form-group">
        ...
        <input class="form-control" type="email" required name="<?= $tabel8_v_input4 ?>" placeholder="Masukkan <?= $tabel8_field4_alias ?>" value="<?= $this->session->userdata($tabel9_field3) ?>">
      </div>

      <div class="form-group">
        <label><?= $tabel8_field5_alias ?></label>
        <input class="form-control" type="text" required name="<?= $tabel8_v_input5 ?>" placeholder="Masukkan <?= $tabel8_field5_alias ?>" value="<?= $this->session->userdata($tabel9_field5) ?>">
      </div>
