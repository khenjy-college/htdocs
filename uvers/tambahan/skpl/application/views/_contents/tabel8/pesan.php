  ...
  <div class="row justify-content-center align-items-end mt-2">
    <div class="col-md-2">
      <div class="form-group">
        ...
        <input class="form-control" type="date" required name="<?= $tabel8_v_input10 ?>" value="<?= $tabel8_v_input10_value ?>" min="<?= date('Y-m-d'); ?>">
      </div>
    </div>
    ...
    <!-- <div class="col-md-2">
      <div class="form-group">
        ...
        <input class="form-control" type="date" required name="<?= $tabel8_v_input11 ?>" value=" $cek_out ?>">
      </div>
    </div> -->
    ...
    <div class="col-md-2">
      <div class="form-group">
        ...
        <input class="form-control" type="date" required name="<?= $tabel8_v_input11 ?>" value="<?= $tabel8_v_input11_value ?>" min="<?= date('Y-m-d', strtotime("+1 day")); ?>">
      </div>
    </div>
    ...
    <div class="col-md-2">
      <div class="form-group">
        ...
        <input class="form-control" readonly type="number" required name="<?= $tabel8_v_input8 ?>" min="1" max="10" value="<?= $tabel8_v_input8_value ?>">
      </div>
    </div>
  ...
  <div class="row justify-content-start mt-4">
    ...
    <div class="col-md-6">
      ...
      <div class="form-group">
        ...
        <input class="form-control" type="text" required name="<?= $tabel8_v_input3 ?>" placeholder="Masukkan <?= $tabel8_field3_alias ?>" value="<?= $this->session->userdata($base_url . $tabel9_field2) ?>">
        <?php if ($this->session->userdata($base_url . $tabel9_field1)) { ?>
          <input type="hidden" name="<?= $tabel9_v_input1 ?>" value="<?= $this->session->userdata($base_url . $tabel9_field1) ?>">
        <?php } else { ?>

          <!-- value 0 di id_user untuk pengguna tanpa akun -->
          <input type="hidden" name="<?= $tabel9_v_input1 ?>" value="0">
      ...
      <div class="form-group">
        ...
        <input class="form-control" type="email" required name="<?= $tabel8_v_input4 ?>" placeholder="Masukkan <?= $tabel8_field4_alias ?>" value="<?= $this->session->userdata($base_url . $tabel9_field3) ?>">
      </div>

      <div class="form-group">
        <label><?= $tabel8_field5_alias ?></label>
        <input class="form-control" type="text" required name="<?= $tabel8_v_input5 ?>" placeholder="Masukkan <?= $tabel8_field5_alias ?>" value="<?= $this->session->userdata($base_url . $tabel9_field5) ?>">
      </div>

      <div class="form-group">
        <label><?= $tabel8_field6_alias ?></label>
        <input class="form-control" type="text" required name="<?= $tabel8_v_input6 ?>" placeholder="Masukkan <?= $tabel8_field6_alias ?>">
      </div>

      <div class="form-group">
        <label><?= $tabel6_field2_alias ?></label>
        <select class="form-control" required name="<?= $tabel6_v_input1 ?>">
    ...
    <div class="modal-content">
      ...
      <form action="<?= site_url('tabel8/pemesanan') ?>" method="get">
        <div class="modal-body">
          <div class="form-group">
            <label><?= $tabel8_field8_alias ?></label>
            <input class="form-control" type="number" value="<?= $tabel8_v_input8_value ?>" required name="<?= $tabel8_v_input8 ?>" min="1" max="10" value="1">
            <input type="hidden" name="<?= $tabel8_v_input10 ?>" value="<?= $tabel8_v_input10_value ?>">
            <input type="hidden" name="<?= $tabel8_v_input11 ?>" value="<?= $tabel8_v_input11_value ?>">
