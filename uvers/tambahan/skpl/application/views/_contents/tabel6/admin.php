      ...
      <form action="<?= site_url('tabel6/tambah') ?>" method="post">
        <div class="modal-body">
          <div class="input-group">
            ...
            <input class="form-control" type="text" required name="<?= $tabel6_v_input1 ?>" placeholder="Masukkan <?= $tabel6_field1_alias ?>">
          </div>
          ...
          <div class="input-group">
            ...
            <input class="form-control" type="text" required name="<?= $tabel6_v_input2 ?>" placeholder="Masukkan <?= $tabel6_field2_alias ?>">
          </div>
          ...
          <div class="input-group">
            ...
            <input class="form-control" type="text" required name="<?= $tabel6_v_input3 ?>" placeholder="Masukkan <?= $tabel6_field3_alias ?>">
          </div>
        ...
        <form action="<?= site_url('tabel6/update') ?>" method="post" enctype="multipart/form-data">
          <div class="modal-body">
            <div class="input-group">
              ...
              <input class="form-control" type="text" required name="<?= $tabel6_v_input2 ?>" placeholder="Masukkan <?= $tabel6_field2_alias ?>" value="<?= $tl6->$tabel6_field2 ?>">
              <input type="hidden" name="<?= $tabel6_v_input1 ?>" value="<?= $tl6->$tabel6_field1 ?>">
            </div>
            ...
            <div class="input-group">
              ...
              <input class="form-control" type="text" required name="<?= $tabel6_v_input3 ?>" placeholder="Masukkan <?= $tabel6_field3_alias ?>" value="<?= $tl6->$tabel6_field3 ?>">
            </div>
