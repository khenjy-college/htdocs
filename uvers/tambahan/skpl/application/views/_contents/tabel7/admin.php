...
<div class="row">
  <div class="col-md-6">
    ...
    <?php foreach ($tbl7 as $tl7): ?>
      ...
      <a class="btn btn-info mb-4" href="<?= site_url('tabel12') ?>">
        <i class="fas fa-edit"></i> Kelola <?= $tabel12_alias ?></a>
      <a class="btn btn-info mb-4" href="<?= site_url('tabel13') ?>">
      ...
      <form action="<?= site_url('tabel7/update') ?>" method="post" enctype="multipart/form-data">
        <div class="form-group">
          ...
          <input class="form-control tabel7" required type="text" name="<?= $tabel7_v_input2 ?>"
            value="<?= $tl7->$tabel7_field2; ?>">
          <input type="hidden" name="<?= $tabel7_v_input1 ?>" value="<?= $tl7->$tabel7_field1; ?>">
        </div>

        <div class="form-group">
          <label><?= $tabel7_field6_alias ?></label>
          <textarea class="form-control tabel7" required name="<?= $tabel7_v_input6 ?>"
            rows="3"><?= $tl7->$tabel7_field6; ?></textarea>
        </div>

        <div class="form-group">
          <label><?= $tabel7_field7_alias ?></label>
          <input class="form-control tabel7" required type="text" name="<?= $tabel7_v_input7 ?>"
            value="<?= $tl7->$tabel7_field7; ?>">
        </div>

        <div class="form-group">
          <label><?= $tabel7_field8_alias ?></label>
          <input class="form-control tabel7" required type="text" name="<?= $tabel7_v_input8 ?>"
            value="<?= $tl7->$tabel7_field8; ?>">
        </div>

        <div class="form-group">
          <label><?= $tabel7_field9_alias ?></label>
          <textarea class="form-control tabel7" required name="<?= $tabel7_v_input9 ?>"
            rows="5"><?= $tl7->$tabel7_field9; ?></textarea>
        </div>

        <div class="form-group">
          <label><?= $tabel7_field10_alias ?></label>
          <input class="form-control tabel7" required type="text" name="<?= $tabel7_v_input10 ?>"
            placeholder="Masukkan <?= $tabel7_field10_alias ?>" value="<?= $tl7->$tabel7_field10; ?>">
        </div>

        <div class="form-group">
          <label><?= $tabel7_field11_alias ?></label>
          <input class="form-control tabel7" required type="text" name="<?= $tabel7_v_input11 ?>"
        ...
        <form action="<?= site_url('tabel7/update_tabel7_field12') ?>" method="post">
          <div class="modal-body">
            ...
            <div class="form-group">
              ...
              <select class="form-control" required name="<?= $tabel7_v_input12 ?>">
        ...
        <form action="<?= site_url('tabel7/update_tabel7_field3') ?>" method="post" enctype="multipart/form-data">
          <div class="modal-body">
            ...
            <div class="form-group">
              ...
              <input class="form-control-file" required type="file" name="<?= $tabel7_v_input3 ?>">
              <input type="hidden" name="<?= $tabel7_v_input1 ?>" value="<?= $tl7->$tabel7_field1; ?>">
              <input type="hidden" name="<?= $tabel7_v_input3_alt ?>" value="<?= $tl7->$tabel7_field3; ?>">
            </div>
          </div>
        ...
        <form action="<?= site_url('tabel7/update_tabel7_field4') ?>" method="post" enctype="multipart/form-data">
          <div class="modal-body">
            ...
            <div class="form-group">
              ...
              <input class="form-control-file" required type="file" name="<?= $tabel7_v_input4 ?>">
              <input type="hidden" name="<?= $tabel7_v_input1 ?>" value="<?= $tl7->$tabel7_field1; ?>">
              <input type="hidden" name="<?= $tabel7_v_input4_alt ?>" value="<?= $tl7->$tabel7_field4; ?>">
            </div>
          </div>
        ...
        <form action="<?= site_url('tabel7/update_tabel7_field5') ?>" method="post" enctype="multipart/form-data">
          <div class="modal-body">
            ...
            <div class="form-group">
              ...
              <input class="form-control-file" required type="file" name="<?= $tabel7_v_input5 ?>">
              <input type="hidden" name="<?= $tabel7_v_input1 ?>" value="<?= $tl7->$tabel7_field1; ?>">
              <input type="hidden" name="<?= $tabel7_v_input5_alt ?>" value="<?= $tl7->$tabel7_field5; ?>">
            </div>
          </div>
