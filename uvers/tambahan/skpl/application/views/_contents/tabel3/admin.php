      ...
      <form action="<?= site_url('tabel3/tambah') ?>" method="post">
        <div class="modal-body">
          <div class="form-group">
            ...
            <input class="form-control" type="text" required name="<?= $tabel3_v_input2 ?>" placeholder="Masukkan <?= $tabel3_field2_alias ?>">
          </div>

          <div class="form-group">
            <label><?= $tabel3_field3_alias ?></label>
            <input class="form-control" type="text" required name="<?= $tabel3_v_input3 ?>" placeholder="Masukkan <?= $tabel3_field3_alias ?>">
          </div>
      ...
      <div class="modal-content">
        ...
        <form action="<?= site_url('tabel3/update') ?>" method="post" enctype="multipart/form-data">
          <div class="modal-body">
            <div class="form-group">
              <label><?= $tabel3_field2_alias ?></label>
              <input class="form-control" type="text" required name="<?= $tabel3_v_input2 ?>" value="<?= $tl3->$tabel3_field2; ?>">
              <input type="hidden" name="<?= $tabel3_v_input1 ?>" value="<?= $tl3->$tabel3_field1; ?>">
            </div>

            <div class="form-group">
              <label><?= $tabel3_field3_alias ?></label>
              <input class="form-control" type="text" required name="<?= $tabel3_v_input3 ?>" value="<?= $tl3->$tabel3_field3; ?>">
            </div>
          </div>
