      ...
      <form action="<?= site_url('tabel1/tambah') ?>" method="post">
        <div class="modal-body">
          <div class="form-group">
            ...
            <input class="form-control" type="text" required name="<?= $tabel1_v_input2 ?>" placeholder="Masukkan <?= $tabel1_field2_alias ?>">
          </div>

          <div class="form-group">
            <label><?= $tabel1_field3_alias ?></label>
            <input class="form-control" type="text" required name="<?= $tabel1_v_input3 ?>" placeholder="Masukkan <?= $tabel1_field3_alias ?>">
          </div>
      ...
      <div class="modal-content">
        ...
        <form action="<?= site_url('tabel1/update') ?>" method="post" enctype="multipart/form-data">
          <div class="modal-body">
            <div class="form-group">
              <label><?= $tabel1_field2_alias ?></label>
              <input class="form-control" type="text" required name="<?= $tabel1_v_input2 ?>" value="<?= $tl1->$tabel1_field2; ?>">
              <input type="hidden" name="<?= $tabel1_v_input1 ?>" value="<?= $tl1->$tabel1_field1; ?>">
            </div>

            <div class="form-group">
              <label><?= $tabel1_field3_alias ?></label>
              <input class="form-control" type="text" required name="<?= $tabel1_v_input3 ?>" value="<?= $tl1->$tabel1_field3; ?>">
            </div>
          </div>
