      ...
      <form action="<?= site_url('tabel5/tambah') ?>" method="post" enctype="multipart/form-data">
        <div class="modal-body">
          ...
          <div class="form-group">
            ...
            <select class="form-control" required name="<?= $tabel5_v_input4 ?>">
          ...
          <div class="form-group">
            ...
            <textarea class="form-control" name="<?= $tabel5_v_input5 ?>" placeholder="Masukkan <?= $tabel5_field5_alias ?>"></textarea>
          </div>
            ...
            <form action="<?= site_url('tabel5/update') ?>" method="post" enctype="multipart/form-data">
              <div class="modal-body">
                <div class="form-group">
                  ...
                  <!-- memilih salah satu tipe kamar yang ada -->
                  <label><?= $tabel6_field2_alias ?></label>
                  <input class="form-control" type="text" readonly name="<?= $tabel6_v_input2 ?>" value="<?= $tl6->$tabel6_field2 ?>">
                  <input type="hidden" name="<?= $tabel6_v_input1 ?>" value="<?= $tl6->$tabel5_field2 ?>">
                ...
                <div class="form-group">
                  ...
                  <input type="hidden" name="<?= $tabel5_v_input1 ?>" value="<?= $tl5->$tabel5_field1; ?>">
                </div>

                <div class="form-group">
                  <label><?= $tabel5_field5_alias ?></label>
                  <textarea class="form-control" name="<?= $tabel5__v_input5 ?>" rows="3"><?= $tl5->$tabel5_field5; ?></textarea>
                </div>
              ...
              <div class="modal-body">
                ...
                jika sebaliknya, maka kamar akan menjadi <?= $tabel5_field4_value3_alias ?> -->
                    <?php if ($tl5->$tabel5_field3 <> 0) { ?>
                      <input type="hidden" name="<?= $tabel5_v_input4 ?>" value="<?= $tabel5_field4_value3 ?>">
                    <?php } else { ?>
                      <input type="hidden" name="<?= $tabel5_v_input4 ?>" value="<?= $tabel5_field4_value2 ?>">
                    <?php } ?>
                  </div>
                  ...
                  <div class="col-md-6">
                    ...
                    <div class="form-group">
                      ...
                      <select class="form-control" required name="<?= $tabel4_v_input1 ?>">
                ...
                dan aku juga membutuhkan bantuan ahli UI UX untuk menentukan keputusan terbaik -->
                    <div class="form-group">
                      <label><?= $tabel5_field5_alias ?></label>
                      <textarea class="form-control" required name="<?= $tabel5__v_input5 ?>" rows="3" placeholder="Masukkan <?= $tabel5_field5_alias ?>"></textarea>
                    </div>
                  </div>
                </div>
              </div>
