      ...
      <form action="<?= site_url('tabel12/tambah') ?>" enctype="multipart/form-data" method="post">
        <div class="modal-body">
          <div class="form-group">
            ...
            <input class="form-control" type="text" required name="<?= $tabel12_field2 ?>"
              placeholder="Masukkan <?= $tabel12_field2_alias ?>">
          </div>
          
          <div class="form-group">
            <label><?= $tabel12_field4_alias ?></label>
            <input class="form-control" type="text" required name="<?= $tabel12_field4 ?>"
              placeholder="Masukkan <?= $tabel12_field4_alias ?>">
          </div>
          
          <div class="form-group">
            <label><?= $tabel12_field3_alias ?></label>
            <input class="form-control-file" required type="file" name="<?= $tabel12_v_input3 ?>">
      ...
      <div class="modal-content">
        ...
        <form action="<?= site_url('tabel12/update') ?>" method="post" enctype="multipart/form-data">
          <div class="modal-body">
            ...
            <div class="form-group">
              <label><?= $tabel12_field2_alias ?></label>
              <input class="form-control" type="text" required name="<?= $tabel12_v_input2 ?>"
                value="<?= $tl12->$tabel12_field2; ?>">
              <input type="hidden" name="<?= $tabel12_v_input1 ?>" value="<?= $tl12->$tabel12_field1; ?>">
              * Meski ingin mengubah <?= $tabel12_field2_alias ?> saja, tetap harus mengupload ulang <?= $tabel12_field3_alias ?> juga
            </div>
            
            <div class="form-group">
              <label><?= $tabel12_field4_alias ?></label>
              <input class="form-control" type="text" required name="<?= $tabel12_v_input4 ?>"
            ...
            <div class="form-group">
              ...
              <input class="form-control-file" type="file" name="<?= $tabel12_v_input3 ?>">
              <input type="hidden" name="<?= $tabel12_v_input3_alt ?>" value="<?= $tl12->$tabel12_field3; ?>">
            </div>
          </div>
