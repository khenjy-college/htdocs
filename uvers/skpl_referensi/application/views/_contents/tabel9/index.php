    ...
    <?php foreach ($tbl9 as $tl9): ?>
      ...
      <form action="<?= site_url('tabel9/update_profil') ?>" method="post" enctype="multipart/form-data">
        <div class="form-group">
          ...
          <input class="form-control tabel7" type="text" name="<?= $tabel9_v_input2 ?>"
        ...
        <div class="form-group">
          ...
          <input class="form-control tabel7" type="text" name="<?= $tabel9_v_input3 ?>"
            value="<?= $tl9->$tabel9_field3; ?>">
        </div>

        <div class="form-group">
          <label><?= $tabel9_field5_alias ?></label>
          <input class="form-control tabel7" type="text" name="<?= $tabel9_v_input5 ?>"
        ...
        <form action="<?= site_url('tabel9/update_tabel9_field4') ?>" method="post" enctype="multipart/form-data">
          <div class="modal-body">
            ...
            <div class="input-group">
              ...
              <input class="form-control" type="password" required name="<?= $tabel9_v_input4_old ?>"
            ...
            <div class="input-group">
              ...
              <input class="form-control" type="password" required name="<?= $tabel9_v_input4 ?>"
