...
class Omnitags extends CI_Controller
{
    ...
    public function declarew()
    {
        ...
        $jsonData1 = file_get_contents(site_url('assets/json/college_uvers_skpl_referensi.postman_environment.json'));
        ...
        $jsonData2 = file_get_contents(site_url('assets/json/college_uvers_skpl_referensi_tables.postman_environment.json'));
        ...
        $this->flashdatas = array(
            ...
            'tabel7_v_flashdata1_msg_7' => $this->aliases['tabel7_field3_alias'] . ' ' . $this->aliases['tabel7_field2_alias'] . ' berhasil diubah!',
            'tabel7_v_flashdata1_msg_8' => $this->aliases['tabel7_field3_alias'] . ' ' . $this->aliases['tabel7_field2_alias'] . ' gagal diubah!',
            'tabel7_v_flashdata1_msg_9' => $this->aliases['tabel7_field4_alias'] . ' ' . $this->aliases['tabel7_field2_alias'] . ' berhasil diubah!',
            'tabel7_v_flashdata1_msg_10' => $this->aliases['tabel7_field4_alias'] . ' ' . $this->aliases['tabel7_field2_alias'] . ' gagal diubah!',
            'tabel7_v_flashdata1_msg_11' => $this->aliases['tabel7_field5_alias'] . ' ' . $this->aliases['tabel7_field2_alias'] . ' berhasil diubah!',
            'tabel7_v_flashdata1_msg_12' => $this->aliases['tabel7_field5_alias'] . ' ' . $this->aliases['tabel7_field2_alias'] . ' gagal diubah!',
            'tabel7_v_flashdata1_msg_13' => $this->aliases['tabel7_field12_alias'] . ' ' . $this->aliases['tabel7_field2_alias'] . ' berhasil diubah!',
            'tabel7_v_flashdata1_msg_14' => $this->aliases['tabel7_field12_alias'] . ' ' . $this->aliases['tabel7_field2_alias'] . ' gagal diubah!',
