            ...
            <tr>
              ...
              <td>
                <a class="btn btn-light text-info" type="button" data-toggle="modal"
                  data-target="#lihat<?= $tl5->$tabel5_field1; ?>">
            ...
            <form action="<?= site_url('tabel5/update') ?>" method="post" enctype="multipart/form-data">
              <div class="modal-body">
                <div class="form-group">
                  ...
                  <input class="form-control" type="text" readonly name="<?= $tabel6_field2_input ?>"
                    value="<?= $tl6->$tabel6_field2 ?>">
                ...
                <div class="form-group">
                  ...
                  <textarea class="form-control" name="<?= $tabel5_field5_input ?>"
                    rows="3"><?= $tl5->$tabel5_field5; ?></textarea>
                </div>
