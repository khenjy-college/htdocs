      ...
      <div class="col-md-5 login">
        ...
        <form action="<?= site_url('tabel4/ceklogin') ?>" method="post">
          ...
          <div class="input-group">
            ...
            <input class="form-control" type="text" name="<?= $tabel4_v_input1 ?>" placeholder="Masukkan <?= $tabel4_field1_alias ?>">
          </div>
          ...
          <div class="input-group">
            ...
            <input class="form-control" type="password" name="<?= $tabel4_v_input4 ?>" placeholder="Masukkan <?= $tabel4_field4_alias ?>">
          </div>
