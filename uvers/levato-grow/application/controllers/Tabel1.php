...
class Tabel1 extends Welcome
{
	public function index($tabel7_field1 = 1)
	{
		...
		$data1 = array(
			$this->v_part1 => $this->views['tabel1_v2_title'],
			$this->v_part2 => $this->head,
			$this->v_part3 => $this->views['tabel1_v2'],
	...
	public function tambah()
	{
		...
		$data = array(
			$this->aliases['tabel1_field1'] => $this->views['tabel1_v_input1_alt'],
			$this->aliases['tabel1_field2'] => $this->views['tabel1_v_input2_post'],
			$this->aliases['tabel1_field3'] => $this->views['tabel1_v_input3_post'],
		);
		...
		if ($simpan) {
			$this->session->set_flashdata($this->flashdatas['v_flashdata1'], $this->flashdatas['tabel1_v_flashdata1_msg_1']);
			$this->session->set_flashdata($this->flashdatas['v_flashdata_a'], $this->flashdatas['v_flashdata_a_func1']);
		} else {
			$this->session->set_flashdata($this->flashdatas['v_flashdata1'], $this->flashdatas['tabel1_v_flashdata1_msg_2']);
			$this->session->set_flashdata($this->flashdatas['v_flashdata_a'], $this->flashdatas['v_flashdata_a_func1']);
		}

		redirect(site_url('tabel1'));
	}
	...
	public function tambah_versi_aman()
	{
		...
		$input1 = htmlspecialchars(trim($this->views['tabel1_v_input1_alt']));
		$input2 = htmlspecialchars(trim($this->views['tabel1_v_input2_post']));
		$input3 = htmlspecialchars(trim($this->views['tabel1_v_input3_post']));
		...
		$data = array(
			$this->aliases['tabel1_field1'] => $input1,
	...
	public function update()
	{
		...
		$tabel1_field1 = $this->views['tabel1_v_input1_post'];
		$data = array(
			$this->aliases['tabel1_field2'] => $this->views['tabel1_v_input2_post'],
			$this->aliases['tabel1_field3'] => $this->views['tabel1_v_input3_post'],
		);
		...
		if ($update) {
			$this->session->set_flashdata($this->flashdatas['v_flashdata1'], $this->flashdatas['tabel1_v_flashdata1_msg_3']);
			$this->session->set_flashdata($this->flashdatas['v_flashdata_a'], $this->flashdatas['v_flashdata_a_func1']);
		} else {
			$this->session->set_flashdata($this->flashdatas['v_flashdata1'], $this->flashdatas['tabel1_v_flashdata1_msg_4']);
			$this->session->set_flashdata($this->flashdatas['v_flashdata_a'], $this->flashdatas['v_flashdata_a_func1']);
		}
	...
	public function hapus($tabel1_field1 = null)
	{
		...
		unlink($this->views['tabel1_v_input3_upload_path'] . $tabel1_field3);
		$hapus = $this->tl1->hapus($tabel1_field1);

		if ($hapus) {
			$this->session->set_flashdata($this->flashdatas['v_flashdata1'], $this->flashdatas['tabel1_v_flashdata1_msg_5']);
			$this->session->set_flashdata($this->flashdatas['v_flashdata_a'], $this->flashdatas['v_flashdata_a_func1']);
		} else {
			$this->session->set_flashdata($this->flashdatas['v_flashdata1'], $this->flashdatas['tabel1_v_flashdata1_msg_6']);
			$this->session->set_flashdata($this->flashdatas['v_flashdata_a'], $this->flashdatas['v_flashdata_a_func1']);
		}
	...
	public function laporan($tabel7_field1 = 1)
	{
		...
		$data1 = array(
			$this->v_part1 => $this->views['tabel1_v3_title'],
			$this->v_part2 => $this->head,
			$this->v_part4 => $this->v_part4_msg1,
			$this->v_part5 => $this->tl12->dekor('tabel1')->result(),
			'tbl7' => $this->tl7->ambil_tabel7_field1($tabel7_field1)->result(),
		...
		$this->load->view($this->views['tabel1_v3'], $data);
	}
}
