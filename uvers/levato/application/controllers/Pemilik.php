...
class Pemilik extends Welcome
{
	...
	public function update()
	{
		...
		// Hal itu tentunya tergantung preferensi pemilik
	...
	public function update_profil()
	{
		...
		$this->session->set_userdata($this->tabel4_userdata5, $tabel4_field5);

		// kembali ke halaman sebelumnya sesuai dengan masing-masing pemilik dengan level yang berbeda
		redirect($_SERVER['HTTP_REFERER']);
	}
	...
	public function ceklogin()
	{
		...
		if ($method1->num_rows() > 0) {
			...
			if (password_verify($param8, $method8)) {
				$tabel4_field1 = $tabel4[0]->id_pemilik;
				$tabel4_field2 = $tabel4[0]->nama;
				$tabel4_field3 = $tabel4[0]->email;
				$tabel4_field5 = $tabel4[0]->hp;
				...
				// Kalau tidak bisa merusak experience dari pemilik
		...
		// 		$tabel_fielduser = $tabel4[0]->id_pemilik;
		// 		$nama = $tabel4[0]->nama;
		// 		$email = $tabel4[0]->email;
		// 		$hp = $tabel4[0]->hp;
		// 		$level = $tabel4[0]->level;

		// 		$this->session->set_userdata('id_pemilik', $tabel_fielduser);
