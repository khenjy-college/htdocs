    ...
    <tr>
      ...
      <td class="pr-2">
        <div class="input-group">
          ...
          <input type="text" class="form-control" name="<?= $tabel8_field3 ?>" value="<?= $tabel4_field1 ?>">
        </div>
      </td>
      <td>
              ...
              <?php foreach ($tbl6 as $tl6) : ?>
                  ...
                  <div class="col-md-6">
                    <div class="form-group">
                      ...
                      <input type="hidden" name="<?= $tabel6_field2 ?>" value="<?= $tl6->$tabel6_field1 ?>">
                    </div>
                    <hr>
                    ...
                    <div class="form-group">
                      ...
                      <input class="form-control" type="number" required name="<?= $tabel8_field6 ?>" value="<?= $tl6->$tabel6_field2 ?>" placeholder="Masukkan <?= $tabel8_field6_alias ?>">
                    </div>

                    <div class="form-group">
                      <label><?= $tabel8_field8_alias ?> </label>
                      <input class="form-control" readonly type="number" required name="<?= $tabel8_field8 ?>" placeholder="Masukkan <?= $tabel8_field8_alias ?>" value="<?= $tl6->$tabel6_field3 ?>">
                    </div>
                  </div>
