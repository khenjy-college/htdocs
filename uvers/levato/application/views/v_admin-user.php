      ...
      <form action="<?= site_url($tabel9.'/tambah') ?>" method="post">
        <div class="modal-body">
          ...
          <div class="input-group">
            ...
            <input class="form-control" type="text" required name="<?= $tabel9_field3 ?>" placeholder="Masukkan <?= $tabel9_field3_alias ?>">
          </div>
        ...
        <form action="<?= site_url($tabel9.'/update') ?>" method="post" enctype="multipart/form-data">
          <div class="modal-body">
            <div class="input-group">
              ...
              <input class="form-control" type="text" required name="<?= $tabel9_field2 ?>" value="<?= $tl9->$tabel9_field2; ?>">
            ...
            <div class="input-group">
              ...
              <input class="form-control" type="text" required name="<?= $tabel9_field3 ?>" value="<?= $tl9->$tabel9_field3; ?>">
            </div>
            ...
            <div class="input-group">
              ...
              <input class="form-control" type="text" required name="<?= $tabel9_field5 ?>" value="<?= $tl9->$tabel9_field5; ?>">
            </div>
