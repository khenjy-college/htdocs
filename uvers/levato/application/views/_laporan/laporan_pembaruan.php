    ...
    <table class="table">
      ...
      <tbody>
        <?php foreach ($tbl1 as $tl1) : ?>
          <tr>
            <td width="20%"><?= $tl1->$tabel1_field1; ?></td>
            <td width="20%"><?= $tl1->$tabel1_field2 ?></td>
            <td width="20%"><?= $tl1->$tabel1_field3 ?></td>
            <td width="20%"><?= $tl1->$tabel1_field4 ?></td>
            <td width="20%"><?= $tl1->$tabel1_field5 ?></td>
          </tr>
        <?php endforeach ?>
      </tbody>
    </table>
