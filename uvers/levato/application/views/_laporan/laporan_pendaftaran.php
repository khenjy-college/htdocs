    ...
    <table class="table">
      ...
      <tbody>
        <?php foreach ($tbl3 as $tl3) : ?>
          <tr>
            <td width="20%"><?= $tl3->$tabel3_field1; ?></td>
            <td width="20%"><?= $tl3->$tabel3_field2 ?></td>
            <td width="20%"><?= $tl3->$tabel3_field3 ?></td>
            <td width="20%"><?= $tl3->$tabel3_field4 ?></td>
            <td width="20%"><?= $tl3->$tabel3_field5 ?></td>
          </tr>
        <?php endforeach ?>
      </tbody>
    </table>
