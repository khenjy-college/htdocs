        ...
        <form action="<?= site_url() . $tabel1 . '/update' ?>" method="post" enctype="multipart/form-data">
          <div class="modal-body">
            ...
            <div class="form-group">
              ...
              <input class="form-control" type="text" required name="<?= $tabel1_field4 ?>" value="<?= $tl1->$tabel1_field4; ?>">
            </div>

            <div class="form-group">
              <label><?= $tabel1_field5_alias ?></label>
              <input class="form-control" type="text" required name="<?= $tabel1_field5 ?>" value="<?= $tl1->$tabel1_field5; ?>">
            </div>
          </div>
