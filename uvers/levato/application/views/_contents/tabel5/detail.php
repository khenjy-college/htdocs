  ...
  if ($tl5->$tabel5_field1 == '') { ?>   <?php } else { ?>
    ...
    <?php switch ($tl5->$tabel5_field4) {
      ...
      case $tabel5_field4_value5: ?>
        <br><br>
        <h1><?= $tabel5_alias ?> Anda Sudah Diperbaharui<?= $phase ?></h1>
                ...
                <?php foreach ($tbl6 as $tl6): ?>
                  <div class="col-md-6">
                    ...
                    <div class="form-group">
                      ...
                      <input class="form-control" type="date" required name="<?= $tabel3_field5_input ?>"
                        min="<?= date('Y-m-d'); ?>">
                    </div>
                ...
                <?php foreach ($tbl6 as $tl6): ?>
                  ...
                  <div class="col-md-6">
                    ...
                    <div class="form-group">
                      ...
                      <input class="form-control" readonly type="text" required name="<?= $tabel8_field8_input ?>"
                ...
                <?php foreach ($tbl6 as $tl6): ?>
                  ...
                  <div class="col-md-6">
                    ...
                    <div class="form-group">
                      ...
                      <input class="form-control date" type="date" name="<?= $tabel1_field4_input ?>"  min="<?= date('Y-m-d'); ?>" required>
                    </div>
