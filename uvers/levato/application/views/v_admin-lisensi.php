    ...
    <tbody>
      <?php foreach ($tbl5 as $tl5) : ?>
        <tr>
          ...
          <td><?= $tl5->$tabel5_field2 ?></td>
          <td><?= $tl5->$tabel5_field3 ?></td>
          <td><?= $tl5->$tabel5_field4 ?></td>
          <td><?= $tl5->$tabel5_field5 ?></td>
          <td><?= $tl5->$tabel5_field6 ?></td>
          <td><?= $tl5->$tabel5_field7 ?></td>
      ...
      <form action="<?= site_url() . $tabel5 . '/tambah' ?>" method="post">
        <div class="modal-body">
          ...
          <div class="form-group">
            ...
            <input class="form-control" type="text" required name="<?= $tabel5_field4 ?>" placeholder="Masukkan <?= $tabel5_field4_alias ?>">
          </div>

          <div class="form-group">
            <label><?= $tabel5_field5_alias ?></label>
            <input class="form-control" type="text" required name="<?= $tabel5_field5 ?>" placeholder="Masukkan <?= $tabel5_field5_alias ?>">
          </div>

          <div class="form-group">
            <label><?= $tabel5_field6_alias ?></label>
            <input class="form-control" type="text" required name="<?= $tabel5_field6 ?>" placeholder="Masukkan <?= $tabel5_field6_alias ?>">
          </div>

          <div class="form-group">
            <label><?= $tabel5_field7_alias ?></label>
            <input class="form-control" type="text" required name="<?= $tabel5_field7 ?>" placeholder="Masukkan <?= $tabel5_field7_alias ?>">
          </div>
      ...
      <div class="modal-content">
        ...
        <form action="<?= site_url() . $tabel5 . '/update' ?>" method="post" enctype="multipart/form-data">
          <div class="modal-body">
            <div class="form-group">
              <label><?= $tabel5_field2_alias ?></label>
              <input class="form-control" type="text" required name="<?= $tabel5_field2 ?>" value="<?= $tl5->$tabel5_field2; ?>">
              <input type="hidden" name="<?= $tabel5_field1 ?>" value="<?= $tl5->$tabel5_field1; ?>">
            </div>

            <div class="form-group">
              <label><?= $tabel5_field3_alias ?></label>
              <input class="form-control" type="text" required name="<?= $tabel5_field3 ?>" value="<?= $tl5->$tabel5_field3; ?>">
            </div>

            <div class="form-group">
              <label><?= $tabel5_field4_alias ?></label>
              <input class="form-control" type="text" required name="<?= $tabel5_field4 ?>" value="<?= $tl5->$tabel5_field4; ?>">
            </div>

            <div class="form-group">
              <label><?= $tabel5_field5_alias ?></label>
              <input class="form-control" type="text" required name="<?= $tabel5_field5 ?>" value="<?= $tl5->$tabel5_field5; ?>">
            </div>

            <div class="form-group">
              <label><?= $tabel5_field6_alias ?></label>
              <input class="form-control" type="text" required name="<?= $tabel5_field6 ?>" value="<?= $tl5->$tabel5_field6; ?>">
            </div>

            <div class="form-group">
              <label><?= $tabel5_field7_alias ?></label>
              <input class="form-control" type="text" required name="<?= $tabel5_field7 ?>" value="<?= $tl5->$tabel5_field7; ?>">
            </div>
          </div>
      ...
      <div class="modal-content">
        ...
        <form>
          <div class="modal-body">
            ...
            <div class="form-group">
              <label><?= $tabel5_field6_alias ?> : </label>
              <p><?= $tl5->$tabel5_field6; ?></p>
            </div>

            <div class="form-group">
              <label><?= $tabel5_field7_alias ?> : </label>
              <p><?= $tl5->$tabel5_field7; ?></p>
            </div>
          </div>
