...
class M_pembayaran extends CI_Model
{
	...
	{
		$this->db->where('id_pembayaran', $tabel8_field1);
		return $this->db->get($this->tabel8);
	}

	public function ambil_tabel8_field2($tabel8_field3)
	{
		$this->db->where('id_lisensi', $tabel8_field3);
		return $this->db->get($this->tabel8);
	}
	...
	{
		$sql = "DELETE FROM " . $this->tabel8 . " WHERE id_pembayaran =  " . $tabel8_field1 . ";";
